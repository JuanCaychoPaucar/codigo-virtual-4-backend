    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuarioTipo', models.IntegerField(choices=[(1, 'ADMINISTRADOR'), (2, 'CAJERO'), (3, 'MOZO')], db_column='usu_tipo', help_text='Tipo de usuario', verbose_name='Tipo del usuario')),
                ('password', models.TextField(db_column='usu_pass', verbose_name='Contraseña del usuario')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detalleSubtotal', models.DecimalField(db_column='detalle_subtotal', decimal_places=2, max_digits=5, verbose_name='SubTotal includio IGV')),
